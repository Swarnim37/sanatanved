    ...
    <div>
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to Sanatanved.com.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Sanatanved.com, accessible from{" "}
          <a href="www.sanatanved.com" rel="external nofollow noopener">
            www.sanatanved.com
          </a>
        </li>
        <li>
      ...
      <ul>
        <li>By email: sanatanvedicastrology@gmail.com</li>
      </ul>
    </div>
  );
};
